...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <table class="auto-style7" style="height: 724px">
        <tr>
            <td class="auto-style14"><strong style="color: #00FFFF">עמוד מוצר</strong></td>
        </tr>
        <tr>
            <td class="auto-style16">
                <asp:GridView ID="gvProductDetails" runat="server" CellPadding="3" Height="397px" Width="1156px" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                    <Columns>
        ...
        <tr>
            <td class="auto-style17">
                <br />
                <asp:Image ID="ImagePegi" runat="server" />
                <span class="auto-style20"><strong>:הגבלת גיל</strong></span><br class="auto-style21" />
                <br />
                <asp:Label ID="txtReq" runat="server" style="font-weight: 700; font-size: large; color: #00FF00"></asp:Label>
                <span class="auto-style18"><strong>:דרישות</strong></span><br />
 ...
 <div id="divRateCnt">
  ...
  <input type="radio" name="rating" id="star1" value="1" onchange="showme(this);"><label for="star1"></label>
                ...
                <br>
<span class="auto-style19">Total vote(s) :</span><br>
