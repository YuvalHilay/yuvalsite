...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <table class="auto-style7" style="height: 755px">
        <tr>
            <td style="color: #00FFFF; font-size: large; text-align: center">רשימת מנהלים</td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="gvAdminList" runat="server" AutoGenerateSelectButton="True" Width="1159px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="705px" DataKeyNames="IDAdmin" OnSelectedIndexChanged="gvAdminList_SelectedIndexChanged">
